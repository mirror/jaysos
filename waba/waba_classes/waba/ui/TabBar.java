/* $Id: TabBar.java,v 1.4 2001/11/02 17:28:44 bornet Exp $
...
public class TabBar extends Container
{
    	                    ...
    	                    int x1, int y1, int x2, int y2)
    {
    	...
    	// top line
    	if(isColor)
    	    g.drawLine(x1 + 1, y1, x2 - 4, y1);
        else
            g.drawLine(x1 + 2, y1, x2 - 6, y1);
    	...
    	if(hasRight)
	    {
		//Right-top round line
		g.drawLine(x2 - 5, y1 + 1, x2 - 5, y1 + 1);
		//Diagnol line
    		g.drawLine(x2 - 4, y1 + 2, x2, y2 - 1);
    		
		if(isColor)
		    {
			//Diagnol light line
    			g.setColor(100, 100, 100);
    			g.drawLine(x2 - 3, y1 + 2, x2 + 1, y2 - 1);
		    }
	    }
    }
