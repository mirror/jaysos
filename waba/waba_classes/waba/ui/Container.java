/* $Id: Container.java,v 1.3 2001/08/18 20:37:52 bornet Exp $
    ...
    */
    ...
    public void paintChildren(Graphics g, int x, int y, int width, int height)
    {
    	...
    	while(child != null)
	    {
    		...
    		g.translate(- cx1, - cy1);
    		child = child.next;
	    }//End of while( (child != null)&&(child.noRepaint) )
    }//End of public void paintChildren(Graphics g, int x, int y, int width, int height)
